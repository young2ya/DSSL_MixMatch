...
def get_cifar10(args, root):
    ...
    train_unlabeled_dataset = CIFAR10SSL(root, train_unlabeled_idxs, train=True, transform=TransformMixMatch(mean=cifar10_mean, std=cifar10_std))
...
def get_cifar100(args, root):
    ...
    train_unlabeled_dataset = CIFAR100SSL(
        ...
        transform=TransformMixMatch(mean=cifar100_mean, std=cifar100_std))
...
class TransformMixMatch(object):
    ...
    def __call__(self, x):
        aug = self.augment(x)
        return self.normalize(aug), self.normalize(aug)
